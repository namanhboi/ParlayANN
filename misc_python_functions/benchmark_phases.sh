...
graph_path=${graph_path:-"../data/optuna_phase_tuning/vamana_combined_phases"}
...
read -p "Enter the type of graph you want to make" type_graph
type_graph=${type_graph:-"all"}
